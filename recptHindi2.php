...
{   
    if($action == "insert") 
    {
     $result = mysql_query("INSERT INTO cb_recpt(CB_DAK_NO, CB_DAK_REC_NO, CB_DAK_DATE, CB_DAK_TOWHOM, CB_DAK_SUB, CB_DAK_FILENO, CB_DAK_REMARK, CB_DAK_TYPE, CB_DAK_N_DATE,CB_DAK_LANG,CB, CB_DAK_RTYPE,CB_DAK_RDATE, CB_DAK_RTHROUGH) VALUES ('$RNO', '$NO', '$DATE', '$TOWHOM', '$SUB', '$FNO', '$REMARK', '$TYPE', '$dt','H','$r_no','$rtype','$RDATE','$rthrough');");
  ...
  $url = "recHindiView.php"; // targ et of the redirect
