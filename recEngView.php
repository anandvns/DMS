...
$result = mysql_query("select * from cb_recpt where CB_DAK_LANG='E' order by CB_DAK_NO");
/*$type = array(
    'A' => "ARMY",
    'N' => "NORMAL",
...
$header = "Receipt Register (ENGLISH) -- (डाक प्राप्ति का रजिस्टर)";
?>
<?php ob_start(); ?>
            ...
            <tbody> 
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    if($_SESSION['utype'] == "D" || $_SESSION['utype'] == "A") 
                          echo "<td>&nbsp;<a href='recptEng.php?op=edit&Id=$row[CB]'>$row[CB_DAK_NO]</a></td>"; 
					      else 
