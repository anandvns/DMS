...
if(isset($_GET['op']) && isset($_GET['Id']))
{
    ...
    $result1 = mysql_query("select * from cb_recpt where CB='$Id' and CB_DAK_LANG='E'");
...
$header = "Receipt Register (ENGLISH) -- Add New (डाक प्राप्ति का रजिस्टर)";
?>
<?php ob_start(); ?>
 <div class="box box-info">        
 <form id="myform" role="form" class="form-horizontal" action="recptEng2.php" onsubmit="return validateForm(this)" enctype="multipart/form-data" method="post" >
