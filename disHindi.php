...
if(isset($_GET['op']) && isset($_GET['Id']))
{
    ...
    $result1 = mysql_query("select * from cb_dispatch where CB='$Id' and CB_DAK_LANG='H'");
...
$header = "Dispatch Register (HINDI) -- Add New (डाक भेजने का रजिस्टर)";
?>
<?php ob_start(); ?>
 <div class="box box-info">        
 <form role="form" class="form-horizontal" action="disHindi2.php" onsubmit="return validateForm(this);" enctype="multipart/form-data" method="post" >
