...
{   
    if($action == "insert") 
    {
    $result = mysql_query("INSERT INTO cb_dispatch(CB_DAK_NO, CB_DAK_DATE, CB_DAK_TOWHOM, CB_DAK_SUB, CB_DAK_FILENO, CB_DAK_FROM, CB_DAK_REMARK, CB_DAK_TYPE, CB_DAK_N_DATE,CB_DAK_LANG,CB,CB_DAK_RTHROUGH) VALUES ('$RNO', '$DATE', '$TOWHOM', '$SUB', '$FNO', '$FROM', '$REMARK', '$TYPE', '$dt','E','$r_no','$rthrough');");
...
$url = "disEngView.php"; // targ et of the redirect
