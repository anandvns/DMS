...
$result = mysql_query("select * from cb_dispatch where CB_DAK_LANG='H' order by CB_DAK_NO desc");
            ...
            <tbody> 
                ...
                while ($row = mysql_fetch_assoc($result)) {
                    ...
                    if($_SESSION['utype'] == "D" || $_SESSION['utype'] == "A") 
                          echo "<td>&nbsp;<a href='disHindi.php?op=edit&Id=$row[CB]'>$row[CB_DAK_NO]</a></td>"; 
					      else 
